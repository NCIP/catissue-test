...
{
###########################################################################################################
# Generating ANT Target for running concept code server
###########################################################################################################

	
	$ant_cmd = "ant -f " . $Deidentifier_home . $slash . "build.xml" . " run_concept_code_server";
	$ant_cmd_log   = $Logs_dir . "\/" . "ant_start_concept_code.log";
